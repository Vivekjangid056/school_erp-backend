    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('1', 'Super Admin'), ('2', 'Institute Owner')], max_length=2)),
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user can belong to multiple groups. A group grants access to a set of permissions.', related_name='admin_set', to='auth.group', verbose_name='groups')),
...
<<<<<<< HEAD
                ...
                ('first_name', models.CharField(max_length=255)),
                ('last_name', models.CharField(max_length=255)),
                ('role', models.CharField(choices=[('1', 'Institute'), ('2', 'Faculty'), ('3', 'Student')], max_length=2)),
                ('phone_number', models.CharField(blank=True, max_length=20, null=True)),
