...
class InstituteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'session_start_month', 'accredited_by', 'scholar_prefix',
            'scholar_suffix', 'emp_no_prefix', 'no_of_pg_in_tcbook',
            'profile_image', 'auto_enroll_no', 'std_attd_assignment',
            'live_class_show_time', 'allow_edit_emp_attd_time',
            'show_std_contact_no_app', 'auto_admin_number',
            'live_class_log_Std', 'suggest_auto_section', 'send_Std_wc_msg',
            'auto_scholar_no', 'single_login', 'suggest_auto_house',
            'allow_ss_in_app', 'auto_emp_no', 'std_attd_through_live_class',
