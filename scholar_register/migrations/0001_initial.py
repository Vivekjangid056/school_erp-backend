    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_deactivae', models.DateField()),
                ...
                ('obtain_marks', models.IntegerField(blank=True, max_length=255)),
                ('maximum_marks', models.IntegerField(blank=True, max_length=255)),
