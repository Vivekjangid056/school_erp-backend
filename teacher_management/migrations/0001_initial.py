...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('join_date', models.DateField(auto_created=True, auto_now_add=True)),
                ...
                ('passpost_end_date', models.DateField(blank=True, null=True)),
                ...
                ('last_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teacher_management.lmcategorymaster')),
